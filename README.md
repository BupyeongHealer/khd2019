...
알게된 방법론들 : label smoothing, input upsize, 초기에는 input을 augmentation과 함께 vggnet작은모델에 넣고, 이후에는 augmentation 제외 후 fine tuning 형태로 점아 모델 깊은 것 사용, gaussian filter가 좋지 않았다. vggnet or efficientnetB0 이용
