...
if __name__ == '__main__':
    ...
    # hyperparameters
    args.add_argument('--epoch', type=int, default=11)                          # epoch 수 설정
    ...
    if config.mode == 'train':  ### training mode일 때
        ...
        images, labels = dataset_loader(img_path, resize_factor=RESIZE, rescale=RESCALE) ## 여기서 데이터 리스케일 해준다.
        # containing optimal parameters ## 이미지 전처리만 13분걸림.
